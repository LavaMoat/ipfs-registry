...
Currently support is provided for [npm][] packages (the default crated by `npm pack`) as well as [crates][] generated by `cargo package`; let us know if you have a package archive format that you would like to support.
